...
import test from '../../assets/images/test1.jpeg'
import step from'../../assets/images/steps.jpeg';

import feature from '../../assets/images/welcome1.jpg'
...
function LandingPage() {
  ...
  return (
    <div className="landing-page">
      <section className="hero" style={{ backgroundImage: `url(${welcome})`, backgroundSize: 'cover' }}>
  ...
  <p>Welcome to the Party Event Management System - Your Ultimate Solution for Seamless Event Planning. Discover a world of effortless organization, unparalleled convenience, and memorable experiences!</p>
      ...
      <section className="features" id="features" style={{ backgroundImage: `url(${feature})`, backgroundSize: 'cover' }}>
      <h2>Key Features</h2>
      ...
      <section className="how-it-works" id="how-it-works" style={{ backgroundImage: `url(${step})`, backgroundSize: 'cover' }}>
      <h2>How It Works</h2>
          <div className="steps">
            <div className="step">
              <h3>Step 1: Search</h3>
      ...
      <section className="testimonials" id="testimonials" style={{ backgroundImage: `url(${test})`, backgroundSize: 'cover' }}>
      <h2>Testimonials</h2>
